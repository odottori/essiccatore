# Documentazione del Sistema Essiccatore per Salumi
...
## Allegato: Interfaccia Web
Per una descrizione dettagliata dell'interfaccia web, consultare il file **Interfaccia_Web.md**.
